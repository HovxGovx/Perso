...
<script>
    $(document).ready(function() {
        ...
        $('#recherche_dossier').on('input', function() {
            ...
            $.ajax({
                url:'<?= site_url('DossierController/getDossier')?>',
                type:'GET',
                dataType:'json', 
                ...
                success: function(data){
                    ...
                    $.each(data,function(index,piecejointe){
                        ...
                        if (piecejointe.id_dossier == d) {
                            var piecejointes=`
                                <embed src="http://localhost/Domaine/projet/${piecejointe.path_plan}" width="100%" height="600px"/>
                            `;
