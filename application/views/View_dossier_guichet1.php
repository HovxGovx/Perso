...
<script>
    $(document).ready(function() {
        ...
        $('#recherche_dossier').on('input', function() {
            ...
            $.ajax({
                url :'<?= site_url('DossierController/getDossierGuichet')?>',
                type :'GET',
                dataType :'json', 
                            ...
                            var cardHtml = `
                                <div class="card  mb-3 shadow" style="max-width: 400px;">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><strong>Etat du dossier:</strong> ${dossier.Etat}</p>
                                        <div class="gg">
                                            <div class="ccc">
                                    ...
                                    <div class="card-footer  justify-content space-around gg">
                                        <div class="ccc">
                                            <button class="btn btn-danger mx-1 my-4 btnsupprimer" data-id_dossier="${dossier.id_dossier}">
                                                <i class="fas fa-trash"></i> Supprimer
                                            </button>
                                            <button class="btn btn-warning mx-1 my-4 btnmodifdossier" >
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var demandeurhtml =`
                                ...
                                <button id="btndemandeur" class="btn btn-success mx-1 my-2 btndemandeur" data-toggle="modal" data-target="#modifdemandeur" >
                    ...
                    var terrainhtml =`
                                ...
                                <button class="btn btn-success mx-1 my-2 " data-id="${data.id_terrain}">
                                    <i class="far fa-edit"></i> Modifier
                                </button>
                    `;
        ...
        //Script pour changer l'etat du dossier en supprimer pour ne plus etres afficher
        $('#liste-dossiers').on('click','.btnsupprimer', function(){
            var id = $(this).data('id_dossier');
            if (confirm("Êtes-vous sûr de vouloir supprimer cela?")) {
                // Si l'utilisateur clique sur "OK", effectue la suppression (simulée ici)
                $.ajax({
                    url: '<?= site_url('DossierController/supprimerDossier/')?>' + id,
                success: function(data){
                ...
                // Si l'utilisateur clique sur "Annuler", n'effectue pas la suppression
                        ...
                        <form action="<?php echo base_url('CelController/ajouterDonnees');?>" method="post" id="formulaire_cel" enctype="multipart/form-data">
                            ...
                            <div class="etape" id="etape1">
                                <div class="form-group">
                                    ...
                                    <input class="form-control d-none" name="id_dossier" type="text" class="form-control" id="id_dossier">
                                ...
                                <div class="form-group">
                                    <label for="avis_cel">AVIS CEL :</label>
                                    <input class="form-control" type="text" id="avis_cel" name="avis_cel">
                                </div> 
                                 <div class="form-group">
                                    <label for="avis_srat">AVIS SRAT :</label>
                                    <input class="form-control" type="text" id="avis_srat" name="avis_srat">
                                </div> 
                                <div class="form-group">
                                    <label for="avis_tp">AVIS TP :</label>
                                    <input class="form-control" type="text" id="avis_tp" name="avis_tp">
                                </div> 
                               <div class="form-group">
                                    <label for="avis_eauetforet">AVIS Eau et Forêt :</label>
                                    <input class="form-control" type="text" id="avis_eauetforet" name="avis_eauetforet">
                                </div> 
                                <div class="form-group">
                                    <label for="autre_avis">Autre avis ou observations:</label>
                                    <input class="form-control" type="text" id="autre_avis" name="autre_avis">
                                </div> 
                               
                                <!--<div class="form-group">
                                    <p>
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat nemo nihil, similique modi ipsum blanditiis quae adipisci, commodi ut mollitia sunt cumque distinctio excepturi labore! Quia explicabo earum sapiente enim?
                                    </p>
                                </div>-->                 
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="submit" id="btnSave" class="btn bg-primary-3">Enregistrer</button>
                    </div>
                </div>
            </div>
        </div>
