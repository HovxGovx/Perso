		...
		<div class="row">
			<div class="col-12">
				<strong style="text-align: center;
                    color: orange;
                    font-size: 1.5em;margin-left: 40%">Suivie des dossiers CCDF</strong>
			</div>
			<br>
			<div class="col-12">
				<div id="liste-dossiers">
					<form action="#">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								<?php foreach ($ccdfsuivi as $value) : ?>
									<tr>
									<td><strong><?php echo $value['num_affaire']; ?></strong></td>
										...
										<td>
											...
											$etatClass = '';
											$etat = '';
											if ($value['Etat'] == "Pour Avis CCDF") {																																													
												$etat = "En attente d'avis CCDF";
												$etatClass = 'bg-primary text-white';
											} elseif ($value['Etat'] == "A-SDC-CCDF") {
												$etatClass = 'bg-info text-white';
												$etat = "Reçu du SDC";
											} elseif ($value['Etat'] == "A-SRD-CCDF") {
												$etatClass = 'bg-info text-white';
												$etat = "Reçu du SRD";
											} elseif ($value['Etat'] == "A-CCDF-SDC") {
												$etatClass = 'bg-white text-white';
												$etat = "Envoyer vers le SDC";
											} elseif ($value['Etat'] == "A-CCDF-SRD") {
												$etatClass = 'bg-info text-white';
												$etat = "Envoyer vers le SRD";
											}
											?>
...
<script src="<?php echo base_url('assets/js/ajax/CCDFsuivi.js?v=' . time()); ?>"></script>
<!-- jQuery -->
