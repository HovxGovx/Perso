								...
								<?php foreach ($srdsuivi as $value) : ?>
									<tr>
										...
										<td>
											...
											$etatClass = '';
											$etat = '';
											if ($value['Etat'] == "A-CCDF-SRD") {
												$etat = "En attente d'avis SRD";
												$etatClass = 'bg-primary text-white';
											} elseif ($value['Etat'] == "A-SRD-CCDF") {
												$etatClass = 'bg-info text-white';
												$etat = "Renvoyer ver CCDF";
											} elseif ($value['Etat'] == "A-SDC-SRD") {
												$etatClass = 'bg-info text-white';
												$etat = "Reçu du SDC";
											} elseif ($value['Etat'] == "A-SRD-SDC") {
												$etatClass = 'bg-info text-white';
...
<script src="<?php echo base_url('assets/js/ajax/SRDsuivi.js?v=' . time()); ?>"></script>
<!-- jQuery -->
