		...
		<div class="row">
			<div class="col-12">
				<strong style="text-align: center;
                    color: orange;
                    font-size: 1.5em;margin-left: 40%"> Dossiers pour avis SRD</strong>
			</div>
			<br>
			<div class="col-12">
				<div id="liste-dossiers">
					<form action="#">
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								<?php foreach ($pouravissrd as $value) : ?>
									<tr>
										...
										<td>
											<button class="btn btn-warning btnTransferer" data-id="<?php echo $value->id_dossier ?>" data-num_affaire="<?php echo $value->num_affaire ?>" data-toggle="modal" data-target="#avis">
												<i class="fas fa-edit"></i> SRD
											</button>
										</td>
									</tr>
								<?php endforeach; ?>
		...
		<div class="modal fade" id="avis" tab-index="1" role="dialog" aria-labelledby="modal_form_label" aria-hidden="false">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="<?php echo base_url('TransferController/ajouterDonneesAvisSRD'); ?>" method="post" class="  mr-2 shadow  px-2 py-2 ">
...
<script src="<?php echo base_url('assets/js/ajax/View_dossier_srd.js?v=' . time()); ?>"></script>
