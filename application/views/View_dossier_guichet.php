						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<button class="btn btn-secondary  btndetails" data-id="<?php echo $onedossier['id_dossier']; ?>" data-toggle="modal" data-target="#detailModalContent">
											Dossier
										</button>
									</td>
									<td>
										...
										<button
											class="btn btn-success  btnconvocation"
											data-toggle="modal"
											data-target="#exampleModalCenter"
											data-id_dossier="<?php echo $onedossier['id_dossier']; ?>"
											data-num_affaires="<?php echo $onedossier['num_affaire']; ?>">
											Convocation
										</button>
										<!-- <button class="btn btn-warning  btnmodifdossier ">
											<a href="<?php //echo base_url() . 'GuichetController/guichetModifDossier/' . $onedossier['id_dossier']; 
														?>  ">
												modification
											</a>
										</button> -->
						...
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="exampleModalLongTitle">Lancement de convocation</h5>
								...
								<div class="modal-body">
									<form>
										...
										<div class="form-group">
											<label for="message-text" class="col-form-label">Date de convocation:</label>
								...
								<div class="modal-footer">
									...
									<button type="button" class="btn btn-primary btnConvoSend">Lancer</button>
								</div>
							</div>
						</div>
					</div>
