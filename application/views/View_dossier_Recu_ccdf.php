		...
		<div class="row">
			<div class="col-12">
				<strong style="text-align: center;
                    color: orange;
                    font-size: 1.5em;margin-left: 40%"> Dossier reçu</strong>
			</div>
			<br>
			<div class="col-12">
...
<script src="<?php echo base_url('assets/js/ajax/View_dossier_Recu_ccdf.js?v=' . time()); ?>"></script>
<!-- jQuery -->
