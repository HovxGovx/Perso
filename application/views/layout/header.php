...
<!-- Inclusion de Popper.js si nécessaire -->
				...
				<ul class="nav nav-treeview">
				  <li class="nav-item">
					<a href="<?php echo base_url().'Ajout_circonscription';?>" class="nav-link">
					  <i class="bi bi-folder-plus" style="margin-left: 10px;"></i>
					  <p style="margin-left: 10px;">Ajout de nouvelle circonscription</p>
					</a>
				  </li>
				  <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="pages/widgets.html" class="nav-link">
              ...
              <p style="margin-left: 10px;">
				...
				<ul class="nav nav-treeview">
				  <li class="nav-item">
					<a href="<?php echo base_url().'Ajout_donnees';?>" class="nav-link">
					  <i class="bi bi-folder-plus" style="margin-left: 10px;"></i>
					  <p style="margin-left: 10px;">Ajout de Dossier</p>
					</a>
				  </li>
				  <li class="nav-item">
					<a href="<?php echo base_url().'Ajout_donnees/view_all_dossiers';?>" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url().'responsable/add';?>" class="nav-link">
                  ...
                  <p style="margin-left: 10px;">Ajouter une personne</p>
                </a>
              </li>
              <li class="nav-item">
