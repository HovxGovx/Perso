  ...
  <nav class="main-header navbar navbar-expand navbar-dark fixed-top">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url().'Main/guichet';?>" class="nav-link">Accueil</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url().'GuichetController/guichetDossier';?>" class="nav-link">Demande</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url().'GuichetController/guichetAjoutDossier';?>" class="nav-link">Ajout</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url().'responsable';?>" class="nav-link">Responsables</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Demande refusée</a>
      </li>
    </ul>
    <!-- Right navbar links -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <p href="#" class="d-block"><?php echo $username;?></p>
        </div>
      </div>
      <!-- /.sidebar-menu -->
    </div>
